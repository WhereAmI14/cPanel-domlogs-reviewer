...
It is designed for fast operator use:

- run directly with `curl | bash`
- avoid permanent installation on the target server
- work interactively or non-interactively
- scale from a few domains to large multi-domain accounts
